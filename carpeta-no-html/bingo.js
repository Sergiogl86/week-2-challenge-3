...
let Carton_Bingo = {
    ...
    Parida: { 
        ...
        Puntos: 100,
         ...
         Jugar_Partida(){
            ...
            do{
                ...
                do{
                    if (!isNaN(Nombre_del_jugador)){
                        Nombre_del_jugador = prompt('Nombre incorrecto, vuelva a introducir. ¡Gracias!');  
            ...
            do{
                ...
                carton = prompt ('¿Quiere jugar con el Carton de juego generado?', 'Yes or No');
                if (carton == null){
                    carton = 'yes';
                    continuar = false ;
                }else{
         ...
         Mostrar_Puntos(){
            ...
            console.table(Carton_Bingo.Score.sort(function(a, b){return b.puntos - a.puntos}));
            console.log('/*/*/*/*/*/*/ Hall of Fame /*/*/*/*/*/*/*/*/*/*/');
         },
         Añadir_Puntos(name, score){

            Carton_Bingo.Score.push({name: name, puntos: score});
        ...
        Generar_carton(){
            ...
            for (let Line in Carton_Bingo.Lineas) {
                for (let numero in Carton_Bingo.Lineas[Line]) {                
                ...
                for (let Line in Carton_Bingo.Lineas) {
                    ...
                    for (let numero in Carton_Bingo.Lineas[Line]) {                
                        if(!isNaN(Carton_Bingo.Lineas[Line][numero])){
                            Max_Num_Line = Max_Num_Line + 1
                        }
                    }
                    if (isNaN(Carton_Bingo.Lineas[Line][0]) && rellenar && Max_Num_Line < 5){
                    ...
                    for (let Line in Carton_Bingo.Lineas) {
                        ...
                        if (isNaN(Carton_Bingo.Lineas[Line][1]) && rellenar && Max_Num_Line < 5){
                    ...
                    for (let Line in Carton_Bingo.Lineas) {
                        ...
                        if (isNaN(Carton_Bingo.Lineas[Line][2]) && rellenar && Max_Num_Line < 5){
                    ...
                    for (let Line in Carton_Bingo.Lineas) {
                        ...
                        if (isNaN(Carton_Bingo.Lineas[Line][3]) && rellenar && Max_Num_Line < 5){
                            Carton_Bingo.Lineas[Line][3] = numero;
                            vector_numeros.push(numero);
                            rellenar = false;
                        }
                      }
                }else if(40 <= numero && numero < 50){
                    rellenar = true;
                    for (let Line in Carton_Bingo.Lineas) {
                        Max_Num_Line = 0
                        for (let numero in Carton_Bingo.Lineas[Line]) {                
                        ...
                        if (isNaN(Carton_Bingo.Lineas[Line][4]) && rellenar && Max_Num_Line < 5){
                            Carton_Bingo.Lineas[Line][4] = numero;
                            vector_numeros.push(numero);
                            rellenar = false;
                        }
                      }
                }else if(50 <= numero && numero < 60){
                    rellenar = true;
                    for (let Line in Carton_Bingo.Lineas) {
                        Max_Num_Line = 0
                        for (let numero in Carton_Bingo.Lineas[Line]) {                
                        ...
                        if (isNaN(Carton_Bingo.Lineas[Line][5]) && rellenar && Max_Num_Line < 5){
                            Carton_Bingo.Lineas[Line][5] = numero;
                            vector_numeros.push(numero);
                            rellenar = false;
                        }
                      }
                } else if(60 <= numero && numero < 70){
                    rellenar = true;
                    for (let Line in Carton_Bingo.Lineas) {
                        Max_Num_Line = 0
                        for (let numero in Carton_Bingo.Lineas[Line]) {                
                        ...
                        if (isNaN(Carton_Bingo.Lineas[Line][6]) && rellenar && Max_Num_Line < 5){
                            Carton_Bingo.Lineas[Line][6] = numero;
                            vector_numeros.push(numero);
                            rellenar = false;
                        }
                      }
                }else if(70 <= numero && numero < 80){
                    rellenar = true;
                    for (let Line in Carton_Bingo.Lineas) {
                        Max_Num_Line = 0
                        for (let numero in Carton_Bingo.Lineas[Line]) {                
                        ...
                        if (isNaN(Carton_Bingo.Lineas[Line][7]) && rellenar && Max_Num_Line < 5){
                            Carton_Bingo.Lineas[Line][7] = numero;
                            vector_numeros.push(numero);
                            rellenar = false;
                        }
                      }
                }else if(80 <= numero && numero < 90){
                    rellenar = true;
                    for (let Line in Carton_Bingo.Lineas) {
                        Max_Num_Line = 0
                        for (let numero in Carton_Bingo.Lineas[Line]) {                
                        ...
                        if (isNaN(Carton_Bingo.Lineas[Line][8]) && rellenar && Max_Num_Line < 5){
        ...
        console.log (`Los numero salidos hasta el momento son: ${Carton_Bingo.Parida.Bombo}`)
