...
function inserdata (){
    ...
    while(true){
        num1 = prompt('Introduce un numero a calcular o fin para ver los resultados.');
    /*
            ...
            switch (i) {
                ...
                case 2:
                  ...
                  case 4:
                    ...
                    //Sin raiz cuadrada
                    console.log(`Al introducir dos o más valores numericos correctos la Raiz cuadrada no se ha calculado`);
                  break;
              };
