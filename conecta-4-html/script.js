    ...
    Control_CPU: {
        ...
        Primera: 0,
         ...
         Jugar_Conecta4(Contrincante){
            ...
            let jugador = document.getElementsByClassName('Tirada');
        ...
        if(Conecta4.Tablero[Conecta4.Control.Caida][casilla] == 'V'){
            ...
            //debugger;  // <-- the debugger stops here
                ...
                document.getElementById('GameInfBox').innerHTML = '¡Esta columna esta llena! Prueba otra posición.';
        ...
        CaidaFicha() {
            ...
            casilla = 'p' + Conecta4.Control.Caida + Conecta4.Control.Posicion;
            document.getElementById(casilla).style.backgroundColor = Conecta4.Control.Color;
            Conecta4.Tablero[Conecta4.Control.Caida][casilla] = Conecta4.Control.Color;

            }else if(Conecta4.Tablero[Conecta4.Control.Caida][casilla] == 'V' && Conecta4.Control.Caida < 6){
                ...
                if (Conecta4.Control.Conecta4 == true){
                    if(Conecta4.Control.Color == 'blue'){
                        if (Conecta4.Control_CPU.Jugando){
                            document.getElementById('GameInfBox').innerHTML = '¡Jugador CPU Azul ha conseguido Conecta 4!';
                        }else{
                            document.getElementById('GameInfBox').innerHTML = '¡Jugador Azul ha conseguido Conecta 4!';
                        }                        
                    }else if(Conecta4.Control.Color == 'red'){
                        document.getElementById('GameInfBox').innerHTML = '¡Jugador Rojo ha conseguido Conecta 4!';
                    }
            ...
            Cambiar_Jugador(){
                ...
                if(Conecta4.Control.Color == 'blue'){
                    ...
                    if(Conecta4.Control_CPU.Jugando){
                        document.getElementById('GameInfBox').innerHTML = 'Turno del CPU AZUL';
                        Conecta4.CPU_Logica();

                    }else{
                        document.getElementById('GameInfBox').innerHTML = 'Turno del jugador AZUL'; 
                    }
                }
            }else{
                          ...
                          if (Encontrado == false && NumLinea != Peso){
                              ...
                              for (let z = 0; z < 4 ; z++){
                                  ...
                                  if (Tablero[x][posC] == Conecta4.Control.Color){
                                      NumLinea +=1;
                                  }else if(Tablero[x][posC] != 'V' && Tablero[x][posC] != Conecta4.Control.Color){
                                    SolOK = false;
                                  }
                              }
                          }
                           ...
                           if (Encontrado == false && NumLinea != Peso){
                               ...
                               for (let z = 0; z < 4 ; z++){
                                   ...
                                   if (Tablero[ x + z ][posC] == Conecta4.Control.Color){
                                       NumLinea +=1;
                                   }else if(Tablero[ x + z ][posC] != 'V' && Tablero[ x + z ][posC] != Conecta4.Control.Color){
                                    SolOK = false;
                                  }
                               }
                           }
            ...
            CPU_Logica(){
                ...
                if(Conecta4.CPU_Comprueba_Jugador('blue', 4) && Conecta4.Control_CPU.Gana_CPU == 4){
                    debugger;  // <-- the debugger stops here
                    Conecta4.Tirar_ficha(Conecta4.Control_CPU.Elegida);
                    Conecta4.Control_CPU.Gana_CPU = false;
                }else if(Conecta4.CPU_Comprueba_Jugador('red', 4) && Conecta4.Control_CPU.Gana_Jugador == 4){
                    debugger;  // <-- the debugger stops here
                    Conecta4.Tirar_ficha(Conecta4.Control_CPU.Elegida);
                    Conecta4.Control_CPU.Gana_Jugador = false;
                }else if (Conecta4.CPU_Comprueba_Jugador('red', 3) && Conecta4.Control_CPU.Gana_Jugador == 3 && Conecta4.Control_CPU.Evitar != Conecta4.Control_CPU.Elegida){
                    debugger;  // <-- the debugger stops here
                    Conecta4.Tirar_ficha(Conecta4.Control_CPU.Elegida);
                    Conecta4.Control_CPU.Gana_Jugador = false;
                }else if(Conecta4.CPU_Comprueba_Jugador('blue', 3) && Conecta4.Control_CPU.Gana_CPU == 3 && Conecta4.Control_CPU.Evitar != Conecta4.Control_CPU.Elegida){
                    debugger;  // <-- the debugger stops here
                    Conecta4.Tirar_ficha(Conecta4.Control_CPU.Elegida);
                    Conecta4.Control_CPU.Gana_CPU = false;
                }else{
            ...
            CPU_Comprueba_Jugador(color, ps){
                ...
                for (let y = 0; y < 7; y++){
                    ...
                    if(tirada != false){
                        ...
                        }else if(color == 'blue' && Conecta4.Control.Conecta4 == false && ps == 4){
                                debugger;  // <-- the debugger stops here
                                casilla = 'p' + tirada + y;
